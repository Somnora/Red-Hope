...
- **Flares become electronic** (M2): software/electronic faults as a hazard. ~~Repaired by a HUMAN — robots do not repair robots.~~ **SUPERSEDED 2026-07-07d:** the director reversed this — **robots CAN repair and fabricate robots (RC-M retained)**; the human-repairs-electronics idea was a purpose-crutch and is dropped. Who services electronic faults is an open M2 question (robots can); **human purpose comes from abilities robots lack** (morale/luxury/judgment/research), not from a repair monopoly. Interim: flare wear ×3 placeholder stands.
