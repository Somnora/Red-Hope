...
SUBJECTS = {
  "solar": "one single solar panel unit, one wide rectangular photovoltaic panel tilted on one central support pedestal, a single machine, one object alone in empty space",
}
