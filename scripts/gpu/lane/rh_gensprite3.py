...
NEG = ("multiple objects, group, collection, several, scattered, ground, dirt, soil, terrain, regolith, rock base, plinth, floating island, "
       "diorama, cutaway, cross-section, pit, room interior, walls, hangar, "
       "photorealistic, 3d render, blurry, text, multiple objects")

SUBJECTS = {
  "extractor": "one single heavy tracked mining excavator, digging arm, one machine only",
  "habitat":   "one single sealed cylindrical mars habitat module, airlock door, one module only",
  "stockpile": "one single tall stack of cargo crates neatly stacked in one pile, one stack only",
  "solar":     "one single solar array unit, four tilted panels joined on one shared frame",
  "lander":    "one single cargo rocket lander standing on four landing legs, one rocket only",
}
